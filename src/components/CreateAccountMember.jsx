...
// <input placeholder="Driver License Expiry Date" name="driverLicenseExpiryDate" className="form-control" 
//      value={this.state.driverLicenseExpiry} onChange={this.changeDriverLicenseExpiryHandler} />
// </div>
